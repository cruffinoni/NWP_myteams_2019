...
the newly created team.
    \param user_id a character pointer corresponding to the name of the
...
unique identifier corresponding to the newly created channel.
    \param channel_name a character pointer corresponding to the name of
...
/*!
    ...
    \param message a character pointer corresponding to the thread's
    content.
...
/*!
    ...
    \param message a character pointer corresponding to the message's
    content.
    \return On success, 1 is returned. On error, -1 is returned and errno is
    set appropriately
*/
