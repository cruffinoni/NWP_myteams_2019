...
/*!
	\param channel_id a character pointer corresponding to the
 universally unique id assigned to the channel in the team.
	\param channel_name a character pointer corresponding to the
 channel's name.
...
/*!
 ...
 timestamp of the thread's creation.
	\param thread_title a character pointer corresponding to the
 thread title.
	\param thread_body a character pointer corresponding to the
 thread body.
...
//! (/list CLI command), used in a loop over each team
/*!
...
/*!
 ...
 universally unique id assigned to the channel in the team.
	\param channel_name a character pointer corresponding to the
 channel's name.
	\param channel_description a character pointer corresponding to
...
/*!
 ...
 and errno is set appropriately
*/
int client_channel_print_threads(char const *thread_id,
    char const *user_id, time_t thread_timestamp,
...
/*!
	\param thread_id a character pointer corresponding to the
 universally unique id assigned to the thread in the channel.
	\param user_id a character pointer corresponding to the
 universally unique id assigned to the user who created the thread.
...
/*!
	\param sender_id a character pointer corresponding to the
 universally unique id assigned to the user sending the message
...
/*!
	\param channel_id an unsigned integer corresponding to the
 WRONG channel identifier
	\return On success, 1 is returned. On error, -1 is returned
 and errno is set appropriately
*/
...
/*!
	\param user_id a character pointer corresponding to the
 universally unique id assigned to the user.
	\param user_name a character pointer corresponding to theuser's name.
	\param user_status an integer corresponding to the user status
 (0 = not connected; 1 = connected).
	\return On success, 1 is returned. On error, -1 is returned and
 errno is set appropriately
...
/*!
	\param channel_id a character pointer corresponding to the
 universally unique id assigned to the channel.
	\param channel_name a character pointer corresponding to the
 channel's name.
...
/*!
	\param thread_id a character pointer corresponding to the
 universally unique id assigned to the thread.
	\param user_id a character pointer corresponding to the
 universally unique id assigned to the user who created the thread.
	\param thread_timestamp an unsigned integer corresponding to the
 timestamp of the thread's creation.
 ...
 errno is set appropriately
*/
int client_print_thread(char const *thread_id,
    char const *user_id, time_t thread_timestamp,
    char const *thread_title, char const *thread_body);
